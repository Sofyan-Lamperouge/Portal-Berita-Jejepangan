<?php
// trending.php - Halaman artikel terpopuler
...
// Ambil artikel terpopuler (diurutkan berdasarkan views)
...
<head>
    ...
    <title>Trending - Nekoverse</title>
...
<div class="container">
    <div class="page-header">
        <h1>🔥 Trending</h1>
        <p>Artikel paling populer dan paling banyak dibaca di Nekoverse</p>
    </div>
    ...
    <div class="artikel-grid">
        ...
        <div class="artikel-card">
            <div class="trending-badge">#<?= $rank++ ?> Trending</div>
